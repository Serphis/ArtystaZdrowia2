  ...
  return (
    <div className="min-h-screen flex flex-col font-tenor">
      <header className="z-30 shadow-sm sticky top-0">
        ...
        <nav className="bg-white w-full text-black flex flex-wrap justify-center space-x-2 md:space-x-6 py-2 p-1 sm:p-2 text-xs md:text-base font-light tracking-widest">
